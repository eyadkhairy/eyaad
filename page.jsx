...
function MainComponent() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Core",
      description:
        "Dynamic sport promotional content with engaging storytelling and smooth transitions.",
      category: "SPORT",
      youtubeUrl: "https://youtube.com/shorts/THiHgFEC6O4?si=AXypGUG4UBOAwFsH",
      thumbnail: "https://img.youtube.com/vi/THiHgFEC6O4/maxresdefault.jpg",
      tags: ["Sport", "Promo", "Short-form"],
    },
    {
      id: 6,
                ...
                {[
                  ...
                  >
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-3 overflow-hidden">
                      <div
                        className="bg-gradient-to-r from-green-400 to-green-500 h-3 rounded-full transition-all duration-2000 shadow-lg shadow-green-400/30"
                        style={{
                          width: `${skill.level}%`,
